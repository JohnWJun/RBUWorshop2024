...
import style from '@/app/_component/training1.module.css';
            ...
            <div className={style.modal}>
                <div className={style.modalHeader}>
                    ...
                    <div className={style.description}>
                        Create proper folders according to the foldering convention we talked about while in the session.
                    </div>

                    <h5>required folders</h5>
                    &nbsp;
                    <ul>
                        <li>Assets</li>
                        <li>Lists</li>
                    ...
                    <div className={style.group}>
                    <h4>Step2: Program Setup - #1 </h4>
                    

                    <h5>follow the instruction</h5>
                    &nbsp;
                    <ul>
                        <li>1. Click the program you want to set up</li>
                        <li>2. Go to Setup menu</li>
                        <li>3. Double click the Channel tag and 
                            change it to 07 Webinar
                        </li>
                        <li>4. Come back to the main menu(click
                            the program title).
                        </li>
                        <li>5. Click the Event Partner section’s under
                            -lined word, not set, and set as the 
                            picture below. Select the event section 
                            as itself.
                    ...
                    <Image
                    className={style.logo}
                    src="/programSetting1.png"
                    alt="program setting 1 pic"
                    width={900}
                    height={500}
                    priority
                    />
