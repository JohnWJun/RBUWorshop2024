...
var training2_module_css_1 = require("@/app/_component/training2.module.css");
...
function Training2() {
    ...
    return (React.createElement("div", { className: training2_module_css_1["default"].modalBackground },
        React.createElement("div", { className: training2_module_css_1["default"].modal },
            React.createElement("div", { className: training2_module_css_1["default"].modalHeader },
                React.createElement("button", { onClick: onClickBack, className: training2_module_css_1["default"].closeButton },
            ...
            React.createElement("div", { className: training2_module_css_1["default"].modalBody },
                page === 1 && (React.createElement("div", { className: training2_module_css_1["default"].group },
                    React.createElement("h4", null, "Step1: Foldering"),
                    "\u00A0 \u00A0",
                    React.createElement("div", { className: training2_module_css_1["default"].description }, "Your lead journey with Marketo begins here. You may arrive at our website through various channels such as SNS advertisements and web magazines. Once here, you may freely explore the site until you stumble upon something that piques your interest."),
                    ...
                    React.createElement("div", { className: training2_module_css_1["default"].imgBoxVer },
                        React.createElement(image_1["default"], { className: training2_module_css_1["default"].logo, src: "/foldering.png", alt: "foldering pic", width: 800, height: 220, priority: true }),
                        React.createElement("div", { className: training2_module_css_1["default"].imgBoxHor },
                            React.createElement(image_1["default"], { className: training2_module_css_1["default"].logo, src: "/introPic2.png", alt: "introPic2", width: 400, height: 800, priority: true }),
                            React.createElement(image_1["default"], { className: training2_module_css_1["default"].logo, src: "/introPic3.png", alt: "introPic3", width: 450, height: 800, priority: true }))))),
                page === 2 && (React.createElement("div", { className: training2_module_css_1["default"].group },
                    React.createElement("h4", null, "Step2: Known"),
                    React.createElement("div", { className: training2_module_css_1["default"].description }, "You may find yourself here when you come across compelling information that you're eager to download. In our Marketo system, customer leads are primarily captured through minimal effort, typically via form submissions. Of course, leads obtained from regional offline events are manually entered into the Marketo DB. Regardless of the channel through which leads are acquired, they are automatically saved in the Marketo DB based on the email provided by the customers."),
                    React.createElement("h5", null, "Channels:"),
                    "\u00A0",
                    React.createElement("ul", null,
                    ...
                    "\u00A0",
                    React.createElement("div", { className: training2_module_css_1["default"].iframeBox },
                ...
                page === 3 && (React.createElement("div", { className: training2_module_css_1["default"].group },
                    ...
                    "\u00A0",
                    React.createElement("div", { className: training2_module_css_1["default"].iframeBoxLong },
            ...
            React.createElement("div", { className: training2_module_css_1["default"].modalFooter },
                React.createElement("div", { className: training2_module_css_1["default"].seeMoreButtonSection },
                    React.createElement("button", { disabled: page === 1, className: training2_module_css_1["default"].seeMoreButton, onClick: onClickPrev },
                    ...
                    React.createElement("button", { disabled: page === 4, className: training2_module_css_1["default"].seeMoreButton, onClick: onClickNext },
