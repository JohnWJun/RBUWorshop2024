                ...
                <Table className={style.table} aria-label="crossword table">
                    ...
                    <TableBody>
                        <TableRow key="1">
                            ...
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell ><input className={style.input} style={{backgroundColor: key1+key2+key3+key4+key5 === '' ? 'transparent' : key1+key2+key3+key4+key5 === 'DRIVE' ? 'lightgreen' : 'lightcoral'}} placeholder='1→' type="text" value={key1} onChange={onChangeKey1}></input></TableCell>
                            <TableCell ><input className={style.input} style={{backgroundColor: key1+key2+key3+key4+key5 === '' || key2+key6+key14+key20 === '' ? 'transparent' : key1+key2+key3+key4+key5 === 'DRIVE' || key2+key6+key14+key20 === 'REBU'  ? 'lightgreen' : 'lightcoral'}} placeholder='1↓'type="text" value={key2} onChange={onChangeKey2}></input></TableCell>
                        ...
                        <TableRow key="4">
                            ...
                            <TableCell ><input className={style.input} style={{backgroundColor: key16+key17+key18+key19+key20+key21+key22+key23+key24+key25 === '' ? 'transparent' : key16+key17+key18+key19+key20+key21+key22+key23+key24+key25 === 'CONDUCTIVE' ? 'lightgreen' : 'lightcoral'}}placeholder='3→' type="text" value={key16} onChange={onChangeKey16}></input></TableCell>
                        ...
                        <TableRow key="6">
                            ...
                            <TableCell ><input className={style.input} style={{backgroundColor: key27+key28+key29+key30+key31+key32 === '' ? 'transparent' : key27+key28+key29+key30+key31+key32 === 'VACUUM' ? 'lightgreen' : 'lightcoral'}} placeholder='4→'  type="text" value={key27} onChange={onChangeKey27}></input></TableCell>
                        ...
                        <TableRow key="8">
                            ...
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell ><input className={style.input} style={{backgroundColor: key39+key40+key41 === '' ? 'transparent' : key39+key40+key41 === 'SLD' ? 'lightgreen' : 'lightcoral'}}  placeholder='6→' type="text" value={key39} onChange={onChangeKey39}></input></TableCell>
                        ...
                        <TableRow key="10">
                            ...
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell ><input className={style.input} style={{backgroundColor: key50+key51+key52 === '' ? 'transparent' : key50+key51+key52 === 'RAT' ? 'lightgreen' : 'lightcoral'}} placeholder='8→' type="text" value={key50} onChange={onChangeKey50}></input></TableCell>
                        ...
                        <TableRow key="11">
                            ...
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell className={style.dark}> </TableCell>
                            <TableCell ><input className={style.input} style={{backgroundColor: key53+key54+key55+key56+key57 === ''  || key30+key33+key41+key43+key52+key53===''? 'transparent' : key53+key54+key55+key56+key57 === 'ECAFM'  || key30+key33+key41+key43+key52+key53==='UPDATE' ? 'lightgreen' : 'lightcoral'}}  placeholder='9→' type="text" value={key53} onChange={onChangeKey53}></input></TableCell>
